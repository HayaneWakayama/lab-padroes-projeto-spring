package dio.projetos.padroes.projeto.spring.controller;
 ...
 * pois abstrai toda a complexidade de integrações (Banco de Dados H2 e API do ViaCep) em uma interface simples
 * e coesa (API REST).
 *
 * @author Hayane
 */
